...
public class Apartment implements Referenceable {
	...
	/**
	 * This method returns a Reference that captures all information necessary
	 * in a RefAddr or subclasses of the RefAddr class or StringRefAddr
	 */
	public Reference getReference() throws NamingException {
		String classname = Apartment.class.getName();
		StringRefAddr classref = new StringRefAddr("Apartment details", size
				+ ":" + location);
		String classfactoryname = ApartmentFactory.class.getName();
		Reference ref = new Reference(classname, classref, classfactoryname,
				null);
		return ref;
	}

	/**
	 * toString method to print out intelligent information if needed about the
	 * Apartment
	 */
